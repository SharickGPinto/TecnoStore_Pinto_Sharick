...
import controlador.persistencia.implementar.VentaDAOImpl;
...
public class GestorVentas {
   ...
   private final VentaDAO ventaDAO= new VentaDAOImpl();
    ...
    public void registrar(Venta v, ArrayList<ItemVenta> items) {
        ...
        // Si por alguna razon llega un ID distinto de 0, validamos que no exista
        if (v.getId() != 0) {
